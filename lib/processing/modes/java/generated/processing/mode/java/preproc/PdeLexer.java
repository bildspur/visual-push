...
@SuppressWarnings({ "unused", "unchecked", "cast", "rawtypes"  })
...
public PdeLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("color", this), new Integer(177));
					...
					if ( synPredMatched446 ) {
						...
						do {
							if (((LA(1) >= '0' && LA(1) <= '7'))) {
								...
								if ( _cnt450>=1 ) { break _loop450; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
							}
